...
<% List<ArticleDto> list = (List<ArticleDto>)request.getAttribute("articles"); %>
  ...
  <body>
    ...
    titles.forEach(function (title) {
      title.addEventListener("click", function () {
        ...
        location.href = "<%= root %>/article?action=view?viewno=" + this.getAttribute("data-no");
      });
    });
